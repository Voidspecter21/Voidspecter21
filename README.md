...
| [Theory-Practice Gap](https://github.com/Voidspecter21/Theory-Practice-gap-analysis) | Assessing the perceived gap between theory and clinical skill development in nursing students | SPSS |
| [Nurse-Patient Communication](https://github.com/Voidspecter21/Nurse-Patient-communication-analysis) | Quantifying the impact of communication quality on patient satisfaction and care outcomes | SPSS |

---

## 🎓 Education & Training

- 🏥 **BNSc Nursing Science** — University of Ilorin *(2021–Present)*
- 📊 **Data Analytics** — The Data Immersed (TDI), Emerald Cohort *(2024–Present)*
- 📊 **Data Analytics** — Coursera & VextorHub
- ✍️ **Writing in the Sciences** — Coursera
...
*Currently open to data analyst internships, research collaborations, and freelance analysis projects.*
